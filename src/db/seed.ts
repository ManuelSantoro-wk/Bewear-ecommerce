...
const productImages = {
  ...
  "Meias Altas": {
    ...
    Cinza: ["https://iili.io/FbwWO6G.th.webp"],
  },
  "Boné Nocta": {
    Preto: [
...
const categories = [
  ...
  {
    name: "Bermuda & Calções",
    description: "Bermudas e calções para todas as ocasiões",
  },
  {
    name: "Calças",
  ...
  {
    name: "T-shirt",
    description: "T-shirt casuais e desportivas",
  },
  {
    name: "Casacos & Sweatshirts",
    description: "Casacos, corta-ventos e sweatshirts",
  },
  {
    name: "Sapatilhas",
    description: "Sapatilhas casuais e desportivas",
  },
];
...
const products = [
  ...
  {
    name: "Meias Altas",
    description: "Meias altas de algodão, confortáveis e duradouras.",
    categoryName: "Acessórios",
    variants: [
      { color: "Branca", price: 1999 },
      { color: "Preta", price: 1999 },
      { color: "Cinza", price: 1999 },
    ],
  },
  {
    name: "Boné Nocta",
  ...
  // Bermuda & Shorts
  {
    name: "Calções Active",
    description:
      "Calções desportivos para atividades físicas, com tecido que absorve o suor.",
    categoryName: "Bermuda & Calções",
    variants: [
  ...
  {
    name: "Calções Core",
    description: "Calções casual confortável, perfeito para o dia a dia.",
    categoryName: "Bermuda & Calções",
    variants: [
  ...
  {
    name: "Calções Challenger",
    description:
      "Calções com design moderno e confortável, ideal para diversas ocasiões.",
    categoryName: "Bermuda & Calções",
    variants: [
      { color: "Castanho", price: 7499 },
  ...
  },
  {
    ...
    description: "Bermuda premium com qualidade superior e design exclusivo.",
    categoryName: "Bermuda & Calções",
    variants: [
  ...
  // Calças
  {
    name: "Calças Nike Club",
    description:
      "Calças desportivas Nike Club, confortável e versátil para treinos e uso casual.",
    categoryName: "Calças",
    variants: [
      { color: "Bege", price: 15999 },
      { color: "Preta", price: 15999 },
      { color: "Bordô", price: 15999 },
    ],
  },
  {
    name: "Calças Knit",
    description:
      "Calças de malha com tecido macio e confortável, ideal para relaxar.",
    categoryName: "Calças",
    variants: [
      { color: "Preta", price: 12999 },
      { color: "Branca", price: 12999 },
  ...
  {
    name: "Calças Brooklin",
    description:
      "Calças com design urbano e moderno, perfeita para o street style.",
    categoryName: "Calças",
    variants: [
  ...
  },
  {
    name: "Calças Jordan",
    description:
      "Calças Jordan com qualidade premium e design icônico da marca.",
    categoryName: "Calças",
    variants: [
  ...
  {
    name: "T-shirt ACG",
    description: "T-shirt ACG com design técnico e material de alta qualidade.",
  ...
  },
  {
    name: "T-shirt Run",
    description:
      "T-shirt para corrida com tecido respirável e conforto superior.",
    categoryName: "T-shirt",
    variants: [
  ...
  },
  {
    name: "T-shirt Active",
    description:
      "T-shirt esportiva para atividades físicas com tecnologia Dri-FIT.",
    categoryName: "T-shirt",
    variants: [
  ...
  },
  {
    name: "T-shirt Nature",
    description:
      "T-shirt com estampa inspirada na natureza, confortável e estilosa.",
    categoryName: "T-shirt",
    variants: [
  ...
  // Jaquetas & Moletons
  {
    name: "Corta Vento",
    description:
      "Casaco corta-vento leve e resistente, ideal para atividades ao ar livre.",
    categoryName: "Casacos & Sweatshirts",
    variants: [
  ...
  {
    name: "Casaco Windrunner",
    description:
      "Casaco Windrunner com design clássico e proteção contra o vento.",
    categoryName: "Casacos & Sweatshirts",
    variants: [
  ...
  },
  {
    name: "Casaco Style",
    description:
      "Casaco com estilo urbano e moderno, perfeita para compor looks casuais.",
    categoryName: "Casacos & Sweatshirts",
    variants: [
      { color: "Castanho", price: 17999 },
      { color: "Cinza", price: 17999 },
    ],
  },
  {
    name: "Casaco Nike Club",
    description: "Casaco Nike Club com qualidade premium e design atemporal.",
    categoryName: "Casacos & Sweatshirts",
    variants: [
  ...
  // Tênis
  {
    name: "Sapatilhas Nike Vomero",
    description:
      "Sapatilhas Nike Vomero com tecnologia de amortecimento superior para corridas.",
    categoryName: "Sapatilhas",
    variants: [
  ...
  {
    name: "Sapatilhas Nike Panda",
    description:
      "Sapatilhas Nike com design Panda icônico, confortável e estiloso.",
    categoryName: "Sapatilhas",
    variants: [
  ...
  {
    name: "Sapatilhas Nike Air Force",
    description:
      "Sapatilhas Nike Air Force 1, um clássico atemporal com design icônico.",
    categoryName: "Sapatilhas",
    variants: [
  ...
  {
    name: "Sapatilhas Nike Dunk Low",
    description:
      "Sapatilhas Nike Dunk Low com design retrô e conforto moderno.",
    categoryName: "Sapatilhas",
    variants: [
